...
「更新する」を選ぶとWindows版ZIPを自動でダウンロードし、SHA-256を検証してから、アプリ終了後にファイルを置き換えて再起動します。`DAMforWindowsToolsData/`の設定・履歴・差し替え動画には触れません。置き換えに失敗した場合は旧バージョンへ戻して起動します。
...
- **セキュリティソフトが警告する**: 本ツールはDAMへ接続するためにFridaを使用します。セキュリティ機能全体を無効にせず、入手元と配布ZIPのSHA-256を確認してください。
